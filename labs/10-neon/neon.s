// Labo 10 — addition de deux tableaux : scalaire, puis NEON.
...
_start:
    ...
    // version scalaire : 4 tours
    mov x9, #0
1:  ldr w10, [x0, x9, lsl #2]
    ldr w11, [x1, x9, lsl #2]
    add w10, w10, w11
    str w10, [x2, x9, lsl #2]
    add x9, x9, #1
    ...
    // TODO version NEON : ld1 {v0.4s}, [x0] ; ld1 {v1.4s}, [x1] ; add v2.4s, v0.4s, v1.4s ; st1 {v2.4s}, [x2]
